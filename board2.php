...
<body>
	<form action="write.php?board=board2">
		<input type='submit'
			   value='글쓰기'
			   />
	</form>
	<table border="1" width="1000" height="100">
		...
		while($row = mysqli_fetch_array($result)) {
			print "<tr height='50'> <th>".$row['no']."</th><th><A href='content.php?board=board2&no=".$row['no']."'>".$row['title']."</A></th><th>".$row['id']."</th><th>".$row['star']."</th><th>".$row['view']."</th></tr>";
		}
		?>
	</table>
	<p>
	</p>
	<a href='board1.php'>게시판1로 가기</a>
	<p>
	</p>
